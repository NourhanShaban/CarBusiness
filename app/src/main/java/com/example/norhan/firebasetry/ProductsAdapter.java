        ...
        public void onClick(View v) {
            ...
            if (v.getId() == btn_details.getId()){
                                ...
                                try {
                                 //   JSONArray array = new JSONArray(response);
                                    ...
                                    for(int i=0;i<jsonArray.length();i++)
                                    {
                                        ...
                                        engcool.setText(Html.fromHtml("<b>" + "coolant :" + "</b> " +jsonObject1.optString("EngineCoolantTemperature ")));
                ...
                Log.d("MY IDF",String.valueOf(SharedPrefManager.getInstance(mCtx)
                        .getUserId()));
                sellUtils.sendbuy(productList.get(getAdapterPosition()),"Hi "+p.getOwnerName()+System.getProperty("line.separator")+" I want to buy your "+p.getModel()+" car "+System.getProperty("line.separator")+"with price "+p.getPrice());
                Toast.makeText(mCtx,"Request Sent ",Toast.LENGTH_SHORT).show();
            }
