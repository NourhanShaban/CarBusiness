                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new Product(
                                        ...
                                        /* product.getString("soldbought"),*/
                                        product.getString("personName"),product.getString("telephone")
                                ));
                            }

                            //creating adapter object and setting it to recyclerview
                            ProductsAdapter adapter = new ProductsAdapter(MainActivity2.this, productList);
