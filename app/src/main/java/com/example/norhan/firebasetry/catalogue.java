...
public class catalogue extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if(SharedPrefManager.getInstance(this).isLoggedIn()){
        ...
        editTextPrice = (EditText) findViewById(R.id.editeTextPrice);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("ownerID" , Integer.toString(SharedPrefManager.getInstance(getApplicationContext())
                        .getUserId()));
                Log.d("User id ", Integer.toString(SharedPrefManager.getInstance(getApplicationContext())
                        .getUserId()));
