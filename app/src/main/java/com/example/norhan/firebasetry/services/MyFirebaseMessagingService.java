package com.example.norhan.firebasetry.services;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String TO_CAR_ID="carID";
    private static final String TO_USER_ID="toPersonID";
    ...
    private void handleData(Map<String, String> data) {
        ...
        if(notificationType.equals("CB")) {
            ...
            Log.d(TAG, "handleData: notificationTYPE CB");
        }
